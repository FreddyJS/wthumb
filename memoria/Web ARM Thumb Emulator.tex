...
\section{Resultados}
    ...
    \subsection{Simulador ARM Thumb}
    {
        ...
        \begin{enumerate}
            ...
            \item \textbf{CPU}: Parte encargada de la ejecución del programa compilado.
            \item \textbf{Tests Unitarios}: Parte encargada de la ejecución del programa compilado.
        \end{enumerate}
        ...
        Los datos solicitados por el programa mediante las directivas de ensamblador (.byte, .asciz, ...)
...
{
    \begin{enumerate}
        \item \textbf{ARM Developer Documentation}. \href{https://developer.arm.com/documentation/ddi0210/c/Programmer-s-Model/Registers/The-Thumb-state-register-set}{The Thumb-state register set}, 
            \href{https://developer.arm.com/documentation/ddi0210/c/Programmer-s-Model/Operating-modes}{Operating Modes}, \href{https://developer.arm.com/documentation/ddi0210/c/Introduction/Instruction-set-summary/Thumb-instruction-summary?lang=en}{Thumb instruction summary}
        ...
        \item \textbf{CodeMirror Documentation}. \href{https://codemirror.net/docs/}{https://codemirror.net/docs/}
    \end{enumerate}
}
